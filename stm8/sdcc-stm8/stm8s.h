...
#define CLK_RESERVED_1  *(unsigned char*)0x50C2
...
#define CLK_PCKEN_R1    *(unsigned char*)0x50C7
#define CLK_CSSR 	    *(unsigned char*)0x50C8
#define CLK_CCOR	    *(unsigned char*)0x50C9
#define CLK_PCKEN_R2    *(unsigned char*)0x50CA
#define CLK_RESERVED_2  *(unsigned char*)0x50CB
